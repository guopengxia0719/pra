...
public class ResponseModel extends HashMap<String, Object>
{
     ...
     * @param msg 返回内容
     */
    public ResponseModel(Type type, String msg)
    {
     ...
     * @param data 数据对象
     */
    public ResponseModel(Type type, String msg, Object data)
    {
        super.put(CODE_TAG, type.value);
        super.put(MSG_TAG, msg);
        if (data == null)
    ...
    {
        return ResponseModel.success("操作成功", data);
    }
    ...
    {
        return ResponseModel.success(msg, null);
    }
    ...
    {
        return new ResponseModel(Type.SUCCESS, msg, data);
    }
     ...
     * @return 警告消息
     */
    public static ResponseModel warn(String msg)
    {
        return ResponseModel.warn(msg, null);
    }
     ...
     * @return 警告消息
     */
    public static ResponseModel warn(String msg, Object data)
    {
        return new ResponseModel(Type.WARN, msg, data);
    }
    ...
    {
        return new ResponseModel(Type.ERROR, msg, data);
    }
}
